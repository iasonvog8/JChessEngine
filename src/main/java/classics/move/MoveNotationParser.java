 ...
 *
 * https://github.com/iasonvog8/JChessEngine/tree/master/src/main/java/classics/move/MoveNotationParser.java
 *
 * About this class:
 *
 * MoveNotationParser: Create a class to parse and validate standard chess notations
 * like Algebraic Notation (e.g., "e4", "Nf3").
 */
