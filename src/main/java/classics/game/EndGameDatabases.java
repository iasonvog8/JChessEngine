 ...
 *
 * https://github.com/iasonvog8/JChessEngine/tree/master/src/main/java/classics/game/EndgameDatabases.java
 *
 * About this class:
 *
 * For endgame play, you may consider using databases that
 * store the perfect outcome for positions with a small number of
 * pieces (e.g., King and Queen vs. King and Rook). These can help your
 * AI play perfectly in endgame scenarios.
 */

package classics.game;

public class EndGameDatabases {
}
