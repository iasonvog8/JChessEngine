 ...
 *
 * https://github.com/iasonvog8/JChessEngine/tree/master/src/main/java/classics/game/GameResult.java
 *
 * About this class:
 *
 * GameResult: Enumerate the possible game results (checkmate, stalemate, draw, etc.)
 * and provide a class to determine when a game is over.
 */
